...
class App:
    ...
    def on_init(self):
        ...
        self.happiness_counter = Text("%", (self.width - 250, self.height - (356 - self.happiness_text.text_surface.get_height() - counter_padding)), font_family, detector_font_size, self._display_surf, OUTLINER_COLOR)
        ...
        self.engagement_counter = Text("%", (self.width - 250, self.height - (prev_position - self.engagement_text.text_surface.get_height() - counter_padding)), font_family, detector_font_size, self._display_surf, OUTLINER_COLOR)
        ...
        self.tiredness_counter = Text("%", (self.width - 250, self.height - (prev_position - self.tiredness_text.text_surface.get_height() - counter_padding)), font_family, detector_font_size, self._display_surf, OUTLINER_COLOR)
        ...
        self.astonishment_counter = Text("%", (self.width - 250, self.height - (prev_position - self.astonishment_text.text_surface.get_height() - counter_padding)), font_family, detector_font_size, self._display_surf, OUTLINER_COLOR)
        ...
        self.lost_attention_counter = Text("", (self.width - 250, self.height - (prev_position - self.lost_attention_text.text_surface.get_height() - counter_padding)), font_family, detector_font_size, self._display_surf, OUTLINER_COLOR)
    ...
    def update_text(self, happiness, engagement, tiredness, astonishment, lost_attention):
        ...
        self.lost_attention_counter.change_text(str(lost_attention))
    ...
    def on_render(self):
        ...
        self.happiness_counter.render(True)
        self.engagement_counter.render(True)
        self.tiredness_counter.render(True)
        self.astonishment_counter.render(True)
        self.lost_attention_counter.render(True)
